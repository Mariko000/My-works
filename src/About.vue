<script setup>
/**
 * RutenVeil Portfolio - About Component
 * Concept and Contact sections are aligned at the top.
 * Minimized padding to bring content higher.
 */
</script>
    ...
    <div class="content-layout">
      <section class="concept-section">
        ...
        <div class="lang-jp">
          ...
          <p>
            RutenVeilは、ロゴ・パッケージ・UIパーツなどのグラフィック制作から、アプリケーションのシステム開発までをすべて一人で手がけるフルスタックなクリエイターです。
          </p>
           <p>
            すっきりと見やすい画面設計をベースに、鮮やかな色彩の緩急や、触っていてワクワクするような「飽きさせない仕掛け」を組み込んだUI/UXデザインを得意としています。
           </p>
          <p>
            単に見栄えが良いだけではなく、Vue.jsやPythonを用いた実用的なシステム実装までを一気通貫で担当。グラフィック制作のノウハウと確かなエンジニアリングを組み合わせることで、使う人が楽しく、直感的に迷わず操作できるアプリケーションを提供することを目指しています。
          </p>
        </div>
